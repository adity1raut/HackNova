      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pt-20 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              <span className="text-gray-600">Today's TimeTable</span>
            </div>
          </div>
          <button
            onClick={() => navigate("/time-schedule")}
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="flex items-center">
              <span className="text-gray-600">change Assignement</span>
              {/* <span className="ml-2 font-medium text-gray-800">
          ...
          <button
            onClick={() => navigate("/faculty/dashboard/assignment")}
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="flex items-center">
              <span className="text-gray-600">Give Grade to studnet's</span>
              
            </div>
          </div>
          <button
            onClick={() => navigate("/faculty/dashboard/grade")}
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="flex items-center">
              <span className="text-gray-600">See notifications</span>
            </div>
          </div>
          <button
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <button
            onClick={() => navigate("/faculty/dashboard/booking-details")}
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <button
            onClick={() => navigate("/faculty/dashboard/faculty-details")}
            className="w-full py-2 px-4 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-md transition-all duration-300"
          >
            View Details
          </button>
        ...
        <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6">
          ...
          <div className="space-y-2 mb-6">
            <div className="flex items-center">
              <span className="text-gray-600">check events</span>
...
export default FacultyDashbord;
